...
font_size = 12;
path = './Bitumen/Results/LightGBM/';
data_path = './Bitumen/Data/trn_tst/';

%% Read Data

y_pred = table2array(readtable(strcat(path,'lgbm_y_pred.dat')));
...
axis([0 25 0 30]);
saveas(gcf,strcat(path,'lgbm_bitumen.png'))

save(strcat(path,'lgbm_result_bitumen.mat'),'y_pred','r','mse');