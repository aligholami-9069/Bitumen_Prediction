...
font_size = 12;
path = './Bitumen/CGR prediction/Results/Neural Network/Param_OPT/';

%% Read Data

trn_dat = table2array(readtable('./Bitumen/CGR prediction/Data/trn_tst/trn_dat.dat'));
trn_dat = trn_dat(~isnan(trn_dat));

trn_lbl = table2array(readtable('./Bitumen/CGR prediction/Data/trn_tst/trn_lbl.dat'));
