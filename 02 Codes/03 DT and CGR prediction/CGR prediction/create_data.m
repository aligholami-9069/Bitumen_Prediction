...
trn_data_input_output  = readtable('./Bitumen/CGR prediction/Data/trn_input_output.csv');
tst_data_input_output  = readtable('./Bitumen/CGR prediction/Data/tst_input_output.csv');

path = './Bitumen/CGR prediction/Data/trn_tst/';

%% Training, and Test data


trn_lbl = table2array(trn_data_input_output(:,2));
trn_dat = table2array(trn_data_input_output(:,1));
trn_input_output = table2array(trn_data_input_output);

tst_lbl = table2array(tst_data_input_output(:,2));
tst_dat = table2array(tst_data_input_output(:,1));
