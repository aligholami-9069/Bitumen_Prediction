...
trn_dat = table2array(readtable('./Bitumen/DT prediction of ahwaz_307/Data/trn_tst/trn_dat.dat'));

trn_lbl = table2array(readtable('./Bitumen/DT prediction of ahwaz_307/Data/trn_tst/trn_lbl.dat'));
...
for hiddenLayerSize = 8:1:30
    ...
    net = fitnet([hiddenLayerSize,hiddenLayerSize_2],trainFcn);
